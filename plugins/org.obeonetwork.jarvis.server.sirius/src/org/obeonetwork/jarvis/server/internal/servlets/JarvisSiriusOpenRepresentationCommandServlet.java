 ...
 */
@Singleton
public class JarvisSiriusOpenRepresentationCommandServlet extends HttpServlet {
	 ...
	 */
	@Inject
	public JarvisSiriusOpenRepresentationCommandServlet(IJarvisSiriusRepresentationService representationService) {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Optional<RepresentationDto> optionalRepresentation = optionalSessionId.flatMap(sessionId -> {
			return this.representationService.openRepresentation(sessionId, openRepresentationDto);
		});
