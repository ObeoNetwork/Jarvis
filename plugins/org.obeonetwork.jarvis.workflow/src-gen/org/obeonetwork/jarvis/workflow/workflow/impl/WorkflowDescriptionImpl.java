 ...
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.WorkflowDescriptionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.WorkflowDescriptionImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.WorkflowDescriptionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.WorkflowDescriptionImpl#getPages <em>Pages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowDescriptionImpl extends MinimalEObjectImpl.Container implements WorkflowDescription {
    ...
    public EList<PageDescription> getPages() {
        if (pages == null) {
            pages = new EObjectContainmentEList<PageDescription>(PageDescription.class, this, WorkflowPackage.WORKFLOW_DESCRIPTION__PAGES);
        }
        return pages;
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == IdentifiedElement.class) {
            switch (derivedFeatureID) {
                case WorkflowPackage.WORKFLOW_DESCRIPTION__NAME: return DescriptionPackage.IDENTIFIED_ELEMENT__NAME;
                case WorkflowPackage.WORKFLOW_DESCRIPTION__LABEL: return DescriptionPackage.IDENTIFIED_ELEMENT__LABEL;
                default: return -1;
            }
        }
        if (baseClass == DocumentedElement.class) {
            switch (derivedFeatureID) {
                case WorkflowPackage.WORKFLOW_DESCRIPTION__DOCUMENTATION: return DescriptionPackage.DOCUMENTED_ELEMENT__DOCUMENTATION;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == IdentifiedElement.class) {
            switch (baseFeatureID) {
                case DescriptionPackage.IDENTIFIED_ELEMENT__NAME: return WorkflowPackage.WORKFLOW_DESCRIPTION__NAME;
                case DescriptionPackage.IDENTIFIED_ELEMENT__LABEL: return WorkflowPackage.WORKFLOW_DESCRIPTION__LABEL;
                default: return -1;
            }
        }
        if (baseClass == DocumentedElement.class) {
            switch (baseFeatureID) {
                case DescriptionPackage.DOCUMENTED_ELEMENT__DOCUMENTATION: return WorkflowPackage.WORKFLOW_DESCRIPTION__DOCUMENTATION;
                default: return -1;
            }
        }
