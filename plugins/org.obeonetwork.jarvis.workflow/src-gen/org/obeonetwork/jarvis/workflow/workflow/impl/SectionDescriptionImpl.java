...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Section Description</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.SectionDescriptionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.SectionDescriptionImpl#getTitleExpression <em>Title Expression</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.SectionDescriptionImpl#getImagePath <em>Image Path</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.SectionDescriptionImpl#getDescriptionExpression <em>Description Expression</em>}</li>
 *   <li>{@link org.obeonetwork.jarvis.workflow.workflow.impl.SectionDescriptionImpl#getActivities <em>Activities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SectionDescriptionImpl extends IdentifiedElementImpl implements SectionDescription {
    ...
    public EList<ActivityDescription> getActivities() {
        if (activities == null) {
            activities = new EObjectContainmentEList<ActivityDescription>(ActivityDescription.class, this, WorkflowPackage.SECTION_DESCRIPTION__ACTIVITIES);
        }
        return activities;
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == DocumentedElement.class) {
            switch (derivedFeatureID) {
                case WorkflowPackage.SECTION_DESCRIPTION__DOCUMENTATION: return DescriptionPackage.DOCUMENTED_ELEMENT__DOCUMENTATION;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == DocumentedElement.class) {
            switch (baseFeatureID) {
                case DescriptionPackage.DOCUMENTED_ELEMENT__DOCUMENTATION: return WorkflowPackage.SECTION_DESCRIPTION__DOCUMENTATION;
                default: return -1;
            }
        }
