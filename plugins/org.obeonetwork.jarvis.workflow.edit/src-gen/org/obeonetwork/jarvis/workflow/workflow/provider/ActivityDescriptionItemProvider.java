 ...
 * {@link org.obeonetwork.jarvis.workflow.workflow.ActivityDescription} object.
...
public class ActivityDescriptionItemProvider extends IdentifiedElementItemProvider {
    ...
    protected void addLabelExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ActivityDescription_labelExpression_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ActivityDescription_labelExpression_feature", "_UI_ActivityDescription_type"),
    ...
    protected void addImagePathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ActivityDescription_imagePath_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ActivityDescription_imagePath_feature", "_UI_ActivityDescription_type"),
