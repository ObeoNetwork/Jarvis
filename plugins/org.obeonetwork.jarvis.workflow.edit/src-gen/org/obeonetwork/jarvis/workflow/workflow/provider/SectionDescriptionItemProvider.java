 ...
 * {@link org.obeonetwork.jarvis.workflow.workflow.SectionDescription} object.
...
public class SectionDescriptionItemProvider extends IdentifiedElementItemProvider {
    ...
    protected void addTitleExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_SectionDescription_titleExpression_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_SectionDescription_titleExpression_feature", "_UI_SectionDescription_type"),
    ...
    protected void addImagePathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SectionDescription_imagePath_feature"), getString("_UI_PropertyDescriptor_description", "_UI_SectionDescription_imagePath_feature", "_UI_SectionDescription_type"),
    ...
    protected void addDescriptionExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_SectionDescription_descriptionExpression_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_SectionDescription_descriptionExpression_feature", "_UI_SectionDescription_type"),
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SectionDescription"));
    }
