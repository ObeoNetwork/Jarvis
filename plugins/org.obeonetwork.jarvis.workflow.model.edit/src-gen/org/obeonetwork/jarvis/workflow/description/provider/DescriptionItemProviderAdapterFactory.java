...
import org.obeonetwork.jarvis.workflow.description.util.DescriptionAdapterFactory;
    ...
    public static class DescriptionChildCreationExtender implements IChildCreationExtender {
        ...
        protected static class CreationSwitch extends DescriptionSwitch<Object> {
            ...
            public Object caseGroup(Group object) {
                newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.GROUP__EXTENSIONS, DescriptionFactory.eINSTANCE.createWorkflowDescription()));
